...
const GetLeaveBalanceData = require('./postgresqlAPI/GetLeaveBalanceData')
const PutPaidLeave = require('./postgresqlAPI/PutPaidLeave')
...
app.use('/GetLeaveBalanceData', GetLeaveBalanceData)
app.use('/PutPaidLeave', PutPaidLeave)
